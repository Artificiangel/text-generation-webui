...
import warnings
from transformers.generation.utils import logger, GenerateNonBeamOutput, BaseStreamer, GenerateEncoderDecoderOutput, GenerateDecoderOnlyOutput
...
from transformers.generation.stopping_criteria import EosTokenCriteria, StoppingCriteriaList, validate_stopping_criteria
